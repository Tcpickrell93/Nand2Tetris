...
union byte2_u* ReadRAM16k(struct RAM16k *ram, 
    ...
    union bit2_u ram4k_address = {
        .bit2_s.val0 = address->bit14_s.val12,
        .bit2_s.val1 = address->bit14_s.val13,
    };
    return Mux4Way16(
